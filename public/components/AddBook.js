          ...
          addBookPost(state.bookTitle, state.bookDescription, pdfFileInpRef.current.files[0], imagesFileInpRef.current.files).then(data => {
            switch (data) {
              case 1:
                setState({
                  ...state,
                  modalElement: <p>the book saved successfully</p>,
                  showModal: true,
                  modalTitle: 'Success',
              ...
              case 2:
                setState({
                    ...state,
                    modalElement: <p>Some Entries are not right</p>,
                    showModal: true,
                ...
                setState({
                      ...state,
                      modalElement: <p>Book Title already exists</p>,
                      showModal: true,
                ...
                setState({
                      ...state,
                      modalElement: <p>Server Error please contact the Administrator</p>,
                      showModal: true,
