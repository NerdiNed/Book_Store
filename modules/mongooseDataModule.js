...
const fs = require('fs')
const connectionString = 'deleted the string for security issues'
...
function connect() {
  ...
  // add a book with it's descriptions to the database
